export const HOST ="https://whatsapp-clone-l7ig.onrender.com";
...
export const SOCKET_ROUTE = "/socket"; // ✅ Define it first
export const SET_SOCKET = `${SOCKET_ROUTE}/set-socket`; // ✅ Now use it
