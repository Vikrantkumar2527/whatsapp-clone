...
function SearchMessages() {
 ...
 if(searchTerm){
  ...
  return <div className="border-conversation-border border-1  w-ful bg-conversation-panel-background flex flex-col z-10 max-h-screen">
    ...
    <div className="overflow-auto custom-scrollbar h-full">
      <div className="flex items-center flex-col w-full">
        <div className="flex px-5 items-center gap-3 h-14 w-full">
          <div className="bg-panel-header-background flex items-centergap-5 px-3 py-1 rounded-lg flex-grow">
            <div>
              <BiSearchAlt2 className="text-panel-header-icon cursor-pointer text-l mt-1 mr-3
                   "/>
            </div>
            <div>
              <input type="text"
      ...
      <div className="flex justify-center h-full flex-col">
        {
          searchTerm.length > 0 && !searchedMessages.length && <span className="
          text-secondary w-full flex justify-center">
            No messages found
